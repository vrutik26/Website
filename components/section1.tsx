...
function Slide(){
    return (
        <div className="grid md:grid-cols-2">
            <div className="image">
                <Link legacyBehavior href={"/"}><a><Image src={"/images/News1.jpg"} width={600} height={600} alt={""} /></a></Link>
            </div>
...
function Slide1(){
    return (
        <div className="grid md:grid-cols-2">
            <div className="image">
                <Link legacyBehavior href={"/"}><a><Image src={"/images/News2.jpg"} width={600} height={600} alt={""} /></a></Link>
            </div>
            <div className="info flex justify-center flex-col pl-12">
                <div className="cat">
...
function Slide2(){
    return (
        <div className="grid md:grid-cols-2">
            <div className="image">
                <Link legacyBehavior href={"/"}><a><Image src={"/images/News3.jpg"} width={600} height={600} alt={""} /></a></Link>
            </div>
            <div className="info flex justify-center flex-col pl-12">
                <div className="cat">
                ...
                <div className="title">
                    <Link  legacyBehavior href={"https://www.gadgetsnow.com/slideshows/rbi-introduces-digital-rupee-tata-1mg-starts-drone-deliveries-spotify-wrapped-2022-released-musk-meets-tim-cook-and-other-top-tech-news-of-the-week/photolist/95975146.cms"}><a target='_blank' className="text-xl md:text-4xl font-bold text-gray-800 hover:text-gray-600">Safdarjung Hospital faces hacking attack, how it is different from AIIMS cyberattack and other details</a></Link>
                </div>
                <p className="text-gray-500 py-3">
...
function Slide3(){
    return (
        <div className="grid md:grid-cols-2">
            <div className="image">
                <Link legacyBehavior href={"/"}><a><Image src={"/images/News4.jpg"} width={600} height={600} alt={""} /></a></Link>
            </div>
            <div className="info flex justify-center flex-col pl-12">
                <div className="cat">
                    <Link legacyBehavior href={"/"}><a className="text-orange-600 hover:text-orange-800">Tech</a></Link>
