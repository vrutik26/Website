    ...
    return ( 
        <section className="py-16" style={bg}>
            ...
            <h1 className="font-bold text-4xl pb-12 text-center">About Me</h1>
                ...
                <div className="image pl-28">
                    <Link legacyBehavior href={"/"}><a><Image src={"/images/Passportphoto.png"} width={400} height={400} alt={""} /></a></Link>
                </div>
                <div className="info flex justify-start flex-col pl-12">
                    {/* <div className="cat">
                    ...
                    <div className="title pt-6 leading-8">
                        ...
                        <br />
                        <br />
                        <Link legacyBehavior href={"/"}><a className="text-3xl md:text-6xl font-thin text-gray-600 animate-fade-in-down">I &apos;M DEVELOPER</a></Link>
